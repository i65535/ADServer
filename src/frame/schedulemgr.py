# -*- coding: utf-8 -*-
# Copyright (c) 2016-2016 The i65535.
...
from mongodb.dbconst import MAIN_DB_NAME, SCHEDULE_JOB_TABLE
...
class ScheduledMgr(object):
    ...
    def __init__(self):
        ...
        jobstores = {
            'default': MongoDBJobStore(MAIN_DB_NAME,SCHEDULE_JOB_TABLE,dbmgr.conn)
        }
        executors = {
